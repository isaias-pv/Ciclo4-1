...
public class ViewService extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawable1 = res1.getDrawable(R.drawable.servicios_1, getTheme());

        img1 = (ImageView) findViewById(R.id.img1);
        img1.setImageDrawable(drawable1);

        Resources res2 = getResources();
        drawable2 = res2.getDrawable(R.drawable.servicios_2, getTheme());

        img2 = (ImageView) findViewById(R.id.img2);
        img2.setImageDrawable(drawable2);

        Resources res3 = getResources();
        drawable3 = res3.getDrawable(R.drawable.servicios_3, getTheme());
